!function(n) {
    ...
    n.scrollIt = function(t) {
        function e(t) {
            t < 0 || i < t || (t = n("[data-scroll-index=" + t + "]").offset().top + s.topOffset + 1,
            n("html,body").animate({
                scrollTop: t,
                easing: s.easing
            }, s.scrollTime))
        ...
        n(window).on("scroll", function() {
            var i = n(window).scrollTop()
              , t = n("[data-scroll-index]").filter(function(t, e) {
                return i >= n(e).offset().top + s.topOffset && i < n(e).offset().top + s.topOffset + n(e).outerHeight()
        ...
        n(window).on("keydown", function(t) {
            t = t.which;
            return (!n("html,body").is(":animated") || t != s.upKey && t != s.downKey) && (t == s.upKey && 0 < o ? (e(parseInt(o) - 1),
            !1) : !(t == s.downKey && o < i) || (e(parseInt(o) + 1),
            !1))
        }),
        n("body").on("click", "[data-scroll-nav], [data-scroll-goto]", function(t) {
            t.preventDefault(),
            t = n((t = t).target).closest("[data-scroll-nav]").attr("data-scroll-nav") || n(t.target).closest("[data-scroll-goto]").attr("data-scroll-goto"),
            e(parseInt(t))
        })
    }
}(jQuery),
...
function(t) {
    ...
    var g, s, f, o, m, e, l = "Close", y = "BeforeClose", v = "MarkupParse", w = "Open", b = ".mfp", x = "mfp-ready", i = "mfp-removing", r = "mfp-prevent-close", a = !!window.jQuery, _ = c(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            ...
            if (!g.isOpen) {
                ...
                u("BeforeOpen"),
                g.st.showCloseBtn && (g.st.closeBtnInside ? (h(v, function(t, e, i, s) {
        ...
        proto: {
            ...
            getInline: function(t, e) {
                ...
                t.src) {
                    ...
                    return o.length ? ((i = o[0].parentNode) && i.tagName && (T || (C = s.hiddenClass,
                    T = d(C),
                    C = "mfp-" + C),
                    S = o.after(T).detach().removeClass(C)),
    ...
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(t) {
                ...
                I ? s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)" : (s.left = i.left,
                s.top = i.top),
                s
            }
        }
    ...
    function L(t) {
        var e;
        !g.currTemplate[M] || (e = g.currTemplate[M].find("iframe")).length && (t || (e[0].src = "//about:blank"),
...
function(g, o, t, f) {
    ...
    c.prototype = {
        ...
        _findBackgrounds: function() {
            ...
            t.each(function() {
                var t, e, i, s, o, n = g(this), r = y(n), a = 0, l = 0, c = 0, h = 0;
